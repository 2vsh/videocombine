...
def stitch_videos(directory, output_file):
    ...
    # Build output path
    if not output_file:
        output_file = os.path.join(directory, 'stitched_output.mp4')
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python dashcam_stitcher.py <directory> [output_file]")
        print("\nExample:")
    ...
    stitch_videos(directory, output_file)
